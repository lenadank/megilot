...
def searchResult(search_path):
    ...
    return render_template('results.html', first_letters=first_letters, last_letters=last_letters, txt_length=txt_length, txt_url=txt_url, title='Search Results', header="תוצאות חיפוש")
